...
- Verify that release tags will also release the plugin and let claude code instances know that it can be updated.
- Add command that can look at a todo md file and generate a plan or plans for it automatically.
- Add buttons in the action bar for sending to iterate plan and implement plan to claude code like we do with the iterate on feedback command. 